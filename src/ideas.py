...
class IdeasChain(BaseEventChain):
    ...
    PROMPT = """
    Вы пишете введение в цифровые технологии для специалистов нефтепереработки и ваша задача - составить подробный список идей, обсуждаемых в текущей главе книги.
